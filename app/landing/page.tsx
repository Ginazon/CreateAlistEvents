// app/landing/page.tsx - Son ve Hata Giderilmiş Sürüm

import Link from 'next/link'
// React'ın kendisini import etmeye gerek kalmadı
import { FaQrcode, FaPalette, FaHeart, FaShieldAlt } from 'react-icons/fa' 

// Interface'i 'any' tipini kullanarak TypeScript hatasını bypass ettik
interface Feature {
    icon: any; // <-- BU DEĞİŞİKLİK SORUNU ÇÖZMELİ
    title: string;
    desc: string;
}
        ...
        <div className="min-h-screen bg-white font-sans text-gray-800">
            ...
            <section id="fiyatlandirma" className="py-20 px-8 bg-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    {/* Fiyatlandırma Kartları (Krediler) */}
                    <div className="grid md:grid-cols-3 gap-8">
                        
                        {/* Başlangıç Paketi (10 Kredi) */}
            ...
            <footer className="py-6 px-8 text-center border-t text-sm text-gray-500">
                <div className="flex justify-center space-x-6 mb-2">
                    ...
                    <Link href="/" className="hover:text-black">Admin Girişi</Link>
                </div>
