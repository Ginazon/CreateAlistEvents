...
// --- 1. SÖZLÜK (TÜM DİLLER VE TÜM PARÇALAR EKLENDİ) ---
export const dictionary = {
  tr: {
    ...
    public_date_label: '📅 Tarih', public_location_label: '📍 Konum', public_directions_btn: 'Yol Tarifi Al 🗺️', public_details_title: 'Etkinlik Detayları', public_memory_wall: '📸 Anı Duvarı', public_gallery_locked: 'Galeri Kilitli', public_gallery_hint: 'Görmek için giriş yapın.', public_back_dashboard: "← Dashboard'a Dön", public_create_own: "Cereget ile oluştur", public_not_found: "Bulunamadı",
  ...
  en: {
    ...
    landing_hero_title: 'Turn Invitations into a Live Social Network.', landing_hero_desc: 'Smart invites with QR codes.', landing_cta_button: 'View Packages →', landing_login: 'Admin Login', landing_buy: 'Buy Now', feature_1_title: 'Live Design', feature_1_desc: 'Instant preview.', feature_2_title: 'Social Gallery', feature_2_desc: 'Photo sharing.', feature_3_title: 'QR Code', feature_3_desc: 'High quality.', feature_4_title: 'RSVP Management', feature_4_desc: 'WhatsApp & Email.', pricing_title: 'Ready?', pricing_desc: 'Choose package.', price_starter: 'Starter', price_premium: 'Unlimited', price_trial: 'Trial',
    design_studio_title: 'Design Studio', edit_event_title: 'Edit Event', publish_btn: 'Publish', save_changes_btn: 'Save', section_images: '1. Images', label_cover: 'Cover', label_main: 'Main Image', file_btn_label: 'Choose Image', file_no_file: 'No file', section_content: '2. Content', label_title: 'Title', label_message: 'Message', section_details: '3. Details', label_date: 'Date', label_location_name: 'Venue', label_location_url: 'Map Link', section_color: '4. Theme Color', section_form: '5. Questions', add_question_btn: '+ Add Question', locked_fields: '🔒 Standard', question_placeholder: 'Question...', option_placeholder: 'Options...', required_checkbox: 'Required',
    ...
    public_date_label: '📅 Date', public_location_label: '📍 Location', public_directions_btn: 'Get Directions 🗺️', public_details_title: 'Event Details', public_memory_wall: '📸 Memory Wall', public_gallery_locked: 'Gallery Locked', public_gallery_hint: 'Login above to view.', public_back_dashboard: "← Back", public_create_own: "Create with Cereget", public_not_found: "Not Found",
    
    // RSVP FORM (ENGLISH)
    rsvp_title: 'RSVP Form', rsvp_name_label: 'Full Name', rsvp_name_ph: 'Your Name', rsvp_email_label: 'Email', rsvp_email_ph: 'email@example.com', rsvp_status_label: 'Status', rsvp_option_yes: 'Attending 🥳', rsvp_option_no: 'Not Attending 😔', rsvp_count_label: '+ Guests', rsvp_note_label: 'Note', rsvp_note_ph: 'Your message...', rsvp_btn_send: 'Send Response', rsvp_btn_sending: 'Sending...', rsvp_success_title: 'Registered!', rsvp_success_msg: 'Response received.', rsvp_success_hint: 'You can use the gallery below.'
  },
  de: {
    loading: 'Laden...', save: 'Speichern', cancel: 'Abbrechen', edit: 'Bearbeiten', delete: 'Löschen', logout: 'Abmelden', confirm_delete: 'Löschen?',
    dashboard_title: 'Dashboard', dashboard_subtitle: 'Verwalten Sie Events.', my_credits: 'Credits', create_new_event: '+ Neu', no_events: 'Keine Events.', manage: 'Verwalten', download: 'Laden', guests_tab: '📋 Gäste', photos_tab: '📸 Galerie',
    ...
    landing_hero_title: 'Smarte Einladungen.', landing_hero_desc: 'Mit QR-Codes.', landing_cta_button: 'Pakete →', landing_login: 'Login', landing_buy: 'Kaufen', feature_1_title: 'Live Design', feature_1_desc: 'Vorschau.', feature_2_title: 'Galerie', feature_2_desc: 'Fotos.', feature_3_title: 'QR Code', feature_3_desc: 'Druckqualität.', feature_4_title: 'RSVP', feature_4_desc: 'WhatsApp.', pricing_title: 'Bereit?', pricing_desc: 'Wähle Paket.', price_starter: 'Start', price_premium: 'Max', price_trial: 'Test',
    design_studio_title: 'Design Studio', edit_event_title: 'Bearbeiten', publish_btn: 'Veröffentlichen', save_changes_btn: 'Speichern', section_images: '1. Bilder', label_cover: 'Titelbild', label_main: 'Bild', file_btn_label: 'Wählen', file_no_file: 'Kein Bild', section_content: '2. Inhalt', label_title: 'Titel', label_message: 'Nachricht', section_details: '3. Details', label_date: 'Datum', label_location_name: 'Ort', label_location_url: 'Karte', section_color: '4. Farbe', section_form: '5. Fragen', add_question_btn: '+ Frage', locked_fields: '🔒 Standard', question_placeholder: 'Frage...', option_placeholder: 'Optionen...', required_checkbox: 'Pflicht',
    section_extra: '6. Details', add_timeline_btn: '+ Zeitplan', add_note_btn: '+ Notiz', add_link_btn: '+ Link', timeline_time_ph: 'Zeit', timeline_title_ph: 'Event', note_title_ph: 'Titel', note_desc_ph: 'Beschreibung', link_title_ph: 'Button', link_url_ph: 'URL', image_upload_btn: 'Bild',
  ...
  ru: {
    ...
    landing_hero_title: 'Соцсеть.', landing_hero_desc: 'QR-коды.', landing_cta_button: 'Пакеты →', landing_login: 'Вход', landing_buy: 'Купить', feature_1_title: 'Дизайн', feature_1_desc: 'Предпросмотр.', feature_2_title: 'Галерея', feature_2_desc: 'Фото.', feature_3_title: 'QR', feature_3_desc: 'Качество.', feature_4_title: 'RSVP', feature_4_desc: 'WhatsApp.', pricing_title: 'Готовы?', pricing_desc: 'Выберите.', price_starter: 'Старт', price_premium: 'Max', price_trial: 'Проба',
