...
export const dictionary = {
  ...
  // --- EXPORT (PDF/EXCEL) BAŞLIKLARI ---
  pdf_header_identity: 'KIMLIK BILGILERI',
  pdf_header_contact: 'ILETISIM BILGILERI',
  pdf_header_details: 'DETAYLAR & CEVAPLAR',
  pdf_label_name: 'AD',
  pdf_label_status: 'DURUM',
  pdf_label_count: 'KISI',
  pdf_label_phone: 'TEL',
  pdf_label_email: 'MAIL',
  pdf_label_method: 'YONTEM',
  pdf_label_note: 'NOT',
},
  en: {
  ...
  pdf_header_identity: 'IDENTITY INFO',
    pdf_header_contact: 'CONTACT INFO',
    pdf_header_details: 'DETAILS & ANSWERS',
    pdf_label_name: 'NAME',
